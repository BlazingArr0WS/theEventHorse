  ...
  getEventsSuccess = eventData => {
    ...
    this.setState({
      eventCards: eventData.map(event => (
        <EventCardTemplate eventData={event} viewRSVP={this.viewRSVP} />
      ))
    });
  };
    ...
    return (
      <section>
        <div className="col-10 m-auto">
          <div className="col-4 col-md-3 cA2o7fyGq3">Event Board</div>
